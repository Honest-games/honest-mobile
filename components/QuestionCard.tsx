...
import { CardTopContent } from "@/entities/card/ui/card-top-content";
import { CardLikeButton } from "@/features/card-likes";
...
const QuestionCard = (props: QuestionCardProps) => {
  ...
  return (
    <View style={styles.questionCardWrapper}>
      {displayData.shouldShowLevelOnCard && displayData.level && <CardTopContent level={displayData.level} />}
